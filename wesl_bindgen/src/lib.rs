//! # wesl_bindgen
//!
//! 🚀 **Generate typesafe Rust bindings from WESL shaders for wgpu**
//!
//! wesl_bindgen transforms your WGSL shader development workflow by automatically generating
//! Rust types, constants, and boilerplate code that perfectly match your shaders.
//! Powered by [wesl](todo), it integrates seamlessly
...
//! ```no_run
//! use wesl_bindgen::{WgslBindgenOptionBuilder, WgslTypeSerializeStrategy, GlamWgslTypeMap};
//!
...
//!
//! The code generated by wesl_bindgen provides:
//!
...
//!
//! ```no_run
//! # use wesl_bindgen::{WgslBindgenOptionBuilder, WgslTypeSerializeStrategy, GlamWgslTypeMap, WgslShaderSourceType};
//! # use wesl_bindgen::qs::quote;
//! # fn main() -> Result<(), Box<dyn std::error::Error>> {
//! WgslBindgenOptionBuilder::default()
//!     .workspace_root("shaders")
...
//! ## 🔍 Error Handling
//!
//! wesl_bindgen provides detailed error reporting for common issues:
//!
...
fn create_rust_bindings(
	...
	let reusable_bind_groups =
		all_shader_bind_groups.create_reusable_shader_bind_groups();
