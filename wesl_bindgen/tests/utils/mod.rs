...
use wesl_bindgen::bevy_util::DependencyTree;
use wesl_bindgen::SourceFilePath;
...
fn test_dependency_tree_file_enumeration() {
	...
	assert_eq!(
		indexset![
			...
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/mesh_view_types.wgsl"
			),
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/mesh_bindings.wgsl"
			),
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/mesh_types.wgsl"
			),
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/mesh_functions.wgsl"
			),
			SourceFilePath::new(
			...
			SourceFilePath::new("tests/shaders/integration/bevy_pbr_wgsl/pbr.wgsl"),
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/pbr/functions.wgsl"
			),
			SourceFilePath::new("tests/shaders/integration/bevy_pbr_wgsl/pbr/types.wgsl"),
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/pbr/lighting.wgsl"
			),
			...
			SourceFilePath::new(
				"tests/shaders/integration/bevy_pbr_wgsl/pbr/bindings.wgsl"
			),
			SourceFilePath::new("tests/shaders/integration/bevy_pbr_wgsl/wireframe.wgsl"),
