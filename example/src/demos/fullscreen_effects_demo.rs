...
impl Demo for FullscreenEffectsDemo {
	fn new(
		...
		let shader =
			shader_bindings::fullscreen_effects::create_shader_module_relative_path(
				device,
				crate::SHADER_DIR,
		...
		let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
			...
			vertex: shader_bindings::fullscreen_effects::vertex_state(
				&shader,
				&shader_bindings::fullscreen_effects::vs_main_entry(
		...
		let bind_group1 =
			shader_bindings::fullscreen_effects::WgpuBindGroup1::from_bindings(
				device,
		...
		let uniforms_buffer =
			device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
				...
				contents: bytemuck::cast_slice(&[
					shader_bindings::fullscreen_effects::Uniforms(glam::vec4(
						0.8, 1.0, 0.6, 1.0,
					)),
				]),
		...
		let bind_group2 =
			shader_bindings::fullscreen_effects::WgpuBindGroup2::from_bindings(
				device,
		...
		let vertex_buffer =
			device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
				...
				contents: bytemuck::cast_slice(&[
					shader_bindings::fullscreen_effects::VertexInput(glam::vec3(
						-1.0, -1.0, 0.0,
					)),
					shader_bindings::fullscreen_effects::VertexInput(glam::vec3(
						3.0, -1.0, 0.0,
